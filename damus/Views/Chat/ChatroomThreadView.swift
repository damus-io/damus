...
struct ChatroomThreadView: View {
    ...
    private static let untrusted_network_scroll_id = "untrusted-network-disclosure-group"
    private static let untrusted_network_scroll_delay: Double = 0.2
    ...
    var OutsideTrustedNetworkLabel: some View {
        HStack {
            ...
            Image(systemName: "chevron.right")
                ...
                .animation(.easeInOut, value: untrusted_network_expanded)
        }
    ...
    var body: some View {
        ScrollViewReader { scroller in
            ...
            let untrusted_count = untrusted_events.count
                    ...
                    if !untrusted_events.isEmpty {
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            Button(action: {
                                ...
                                OutsideTrustedNetworkLabel
                                    .id(ChatroomThreadView.untrusted_network_scroll_id)
                            }
