    ...
    var body: some View {
        Button(action: {
            ...
            HStack {
                ...
                Text("Connect to Alby", comment: "Button to connect to Alby, a service that provides a Lightning wallet for zapping sats. Alby is the name of the service and should not be translated.")
            }
            .offset(x: -25)
