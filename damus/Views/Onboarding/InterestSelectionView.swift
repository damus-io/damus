        ...
        var body: some View {
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    Text(NSLocalizedString("Please pick between 2 and 4 interests. This will help us recommend accounts to follow.", comment: "Instruction for interest selection"))
                        .font(.subheadline)
