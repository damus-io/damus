    ...
    var body: some View {
        NavigationView {
            TabView(selection: $current_page) {
                ...
                DisinterestSelectionView(next_page: self.next_page, selectedDisinterests: $model.disinterests)
                    .navigationTitle(NSLocalizedString("Select your dislikes", comment: "Title for a screen asking the user for disinterests"))
                    .navigationBarTitleDisplayMode(.inline)
                    .tag(1)
