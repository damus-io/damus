...
struct EditBannerImageView: View {
    ...
    var body: some View {
        ZStack {
            ...
            EditPictureControl(uploader: damus_state.settings.default_media_uploader, context: .normal, keypair: damus_state.keypair, pubkey: damus_state.pubkey, image_url: $banner_image, uploadObserver: viewModel, callback: callback)
                .padding(10)
