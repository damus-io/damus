...
struct NoteContentView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        NoteContentView(keypair: Keypair(pubkey: "", privkey: nil), event: NostrEvent(content: content, pubkey: "pk"), profiles: state.profiles, previews: PreviewCache(), show_images: true, artifacts: artifacts, size: .normal)
    }
}
