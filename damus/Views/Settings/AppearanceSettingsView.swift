    ...
    var body: some View {
        Form {
            ...
            Section(NSLocalizedString("Images", comment: "Section title for images configuration.")) {
                ...
                Toggle(NSLocalizedString("Show carousel image counter", comment: "Setting to determine if the 1 of x counter should be displayed on the carousel"), isOn: $settings.show_carousel_counter)
                    .toggleStyle(.switch)
