...
enum TranslationService: String, CaseIterable, Identifiable, StringCodable {
    ...
    var model: Model {
        ...
        case .none:
            ...
            if TranslationService.isOfflineTranslationSupported {
                displayName = NSLocalizedString("offline_translation_service", value: "Offline Translations", comment: "Dropdown option for selecting the offline translation service provided on-device by Apple.")
            } else {
    ...
    static var isOfflineTranslationSupported: Bool {
