...
//func ensure_relay_info(relays: [RelayPool.RelayDescriptor], content: String) -> [RelayURL: RelayRWConfiguration] {
...
//func make_contact_relays(_ relays: [RelayPool.RelayDescriptor]) -> [RelayURL: RelayRWConfiguration] {
