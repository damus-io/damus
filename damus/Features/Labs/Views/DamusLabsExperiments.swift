...
struct DamusLabsExperiments: View {
    ...
    let zaps_label = NSLocalizedString("Zaps", comment: "Label for a toggle that enables an experimental feature")
    ...
    var body: some View {
        ScrollView {
            ...
            VStack(alignment: .leading, spacing: 30) {
                ...
                LabsToggleView(toggleName: zaps_label, systemImage: "bolt.fill", isOn: $settings.zaps, showInfo: $show_zaps_explainer)
        ...
        .sheet(isPresented: $show_zaps_explainer) {
            LabsExplainerView(
                ...
                labDescription: NSLocalizedString("This enables experimental zap features. We are working to get these features working for everyone!", comment: "Damus Labs feature explanation"))
        }
