...
struct NIP05DomainHelpers {
    ...
    @MainActor
    static func authors_for_domain(domain: String, friend_filter: FriendFilter, contacts: Contacts, profiles: Profiles, ndb: Ndb) -> Set<Pubkey> {
        ...
        case .all:
            ...
            // This enables discovery without requiring follows first
            authors = scan_all_cached_profiles(domain: domain, ndb: ndb)
