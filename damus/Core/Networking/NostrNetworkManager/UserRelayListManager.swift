...
extension NostrNetworkManager {
    ...
    class UserRelayListManager {
        ...
        /// Using OSAtomicQueue would be overkill - worst case of a race is an extra skip, not corruption.
        ...
        func set(userRelayList: NIP65.RelayList) async throws(UpdateError) {
            ...
            // the event before we update the state, causing duplicate processing and UI flickering ("disco" bug).
