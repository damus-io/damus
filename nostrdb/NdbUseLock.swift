...
extension Ndb {
    ...
    class UseLock: UseLockProtocol {
        ...
        func keepNdbOpen<T>(during operation: @escaping () throws -> T, maxWaitTimeout: DispatchTimeInterval = DEFAULT_TIMEOUT) throws -> T {
    ...
    protocol UseLockProtocol {
        ...
        /// - Parameter maxTimeout: The maximum amount of time the function will wait for the lock before giving up.
        /// - Returns: The return result for the given operation
        func keepNdbOpen<T>(during operation: @escaping () throws -> T, maxWaitTimeout: DispatchTimeInterval) throws -> T
