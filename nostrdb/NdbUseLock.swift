...
extension Ndb {
    ...
    class UseLock: UseLockProtocol {
        ...
        func keepNdbOpen<T>(during operation: @escaping () throws -> T, maxTimeout: DispatchTimeInterval = DEFAULT_TIMEOUT) throws -> T {
            try self.incrementUserCount(maxTimeout: maxTimeout)
        ...
        ///
        /// Implementation note: NEVER change this to `async`! This is a blocking operation, so we want to minimize the time of the operation
        func waitUntilNdbCanClose(thenClose operation: @escaping () -> Bool, maxTimeout: DispatchTimeInterval = DEFAULT_TIMEOUT) throws {
    ...
    protocol UseLockProtocol {
        ...
        ///
        /// Implementation note: NEVER change this to `async`! This is a blocking operation, so we want to minimize the time of the operation
        func keepNdbOpen<T>(during operation: @escaping () throws -> T, maxTimeout: DispatchTimeInterval) throws -> T
        ...
        ///
        /// Implementation note: NEVER change this to `async`! This is a blocking operation, so we want to minimize the time of the operation
        func waitUntilNdbCanClose(thenClose operation: @escaping () -> Bool, maxTimeout: DispatchTimeInterval) throws
